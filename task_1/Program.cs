...
else // Важно данную программу составлять с условием "else", так как без этого условия, в случае если первое число ЯВЛЯЕТСЯ квадратом второго, то на выходе будет ответ Да и Нет одновременно
    {
